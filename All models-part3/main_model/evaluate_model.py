...
# Load datasets
data_dir = r'C:\Users\pierh\assignment1\ProjectAssignmentFS_5\data\fulldataset_cleaned_part3'
...
def load_datasets(data_dir):
    ...
    for cls in classes:
        ...
        validate_dir = os.path.join(data_dir, cls, 'validate')
    ...
    return test_dataset, validate_dataset

# Initialize model and datasets
model = SimpleCNN()
test_dataset, validate_dataset = load_datasets(data_dir)
...
evaluate_model(model, validate_loader, nn.CrossEntropyLoss(), dataset_name="Validation")

# Evaluate on the test set
evaluate_model(model, test_loader, nn.CrossEntropyLoss(), dataset_name="Test")
