...
base_dir = r'C:\Users\pierh\assignment1\ProjectAssignmentFS_5\fulldataset_cleaned'
...
# Iterate through each class and each train/test folder
for class_name in class_names:
    class_path = os.path.join(base_dir, class_name)  # This line constructs the correct path to each class
...
for i in unique:
    ...
    sample_indices = random.sample(list(class_indices), min(15, len(class_indices)))  # Randomly select 15 samples
